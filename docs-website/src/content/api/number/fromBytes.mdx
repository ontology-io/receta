...
### fromBytes()
 `>` **fromBytes**(`input`, `base?`): [`Result`](../result/types.md#result)\<`number`, [`ParseError`](types.md#parseerror)\>

Defined in: [number/fromBytes/index.ts:35](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/number/fromBytes/index.ts#L35)

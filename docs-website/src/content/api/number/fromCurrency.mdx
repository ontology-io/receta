...
### fromCurrency()
 `>` **fromCurrency**(`input`): [`Result`](../result/types.md#result)\<`number`, [`ParseError`](types.md#parseerror)\>

Defined in: [number/fromCurrency/index.ts:33](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/number/fromCurrency/index.ts#L33)

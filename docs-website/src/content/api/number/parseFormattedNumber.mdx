...
### parseFormattedNumber()
 `>` **parseFormattedNumber**(`input`): [`Result`](../result/types.md#result)\<`number`, [`ParseError`](types.md#parseerror)\>

Defined in: [number/parseFormattedNumber/index.ts:59](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/number/parseFormattedNumber/index.ts#L59)

...
Defined in: [number/isInteger/index.ts:21](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/number/isInteger/index.ts#L21)

...
Defined in: [async/throttle/index.ts:45](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/async/throttle/index.ts#L45)
...
[`ThrottleOptions`](types.md#throttleoptions)

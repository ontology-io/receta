...
### tryCatch()
 `>` **tryCatch**\<`Args`, `T`, `E`\>(`fn`, `onError?`): (...`args`) => [`Result`](../result/types.md#result)\<`T`, `E`\>

Defined in: [function/tryCatch/index.ts:52](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/function/tryCatch/index.ts#L52)
...
#### Returns
 `>` (...`args`): [`Result`](../result/types.md#result)\<`T`, `E`\>

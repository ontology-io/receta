...
#### Call Signature
 `>` **juxt**\<`Fns`\>(`fns`): (...`args`) => [`ReturnTypes`](types.md#returntypes)\<`Fns`\>

Defined in: [function/juxt/index.ts:67](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/function/juxt/index.ts#L67)
...
##### Returns
 `>` (...`args`): [`ReturnTypes`](types.md#returntypes)\<`Fns`\>
...
[`ReturnTypes`](types.md#returntypes)\<`Fns`\>
...
Defined in: [function/juxt/index.ts:70](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/function/juxt/index.ts#L70)

...
#### Call Signature
 `>` **mapInvalid**\<`T`, `E`, `F`\>(`validation`, `fn`): [`Validation`](types.md#validation)\<`T`, `F`\>

Defined in: [validation/mapInvalid/index.ts:60](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/validation/mapInvalid/index.ts#L60)
...
[`Validation`](types.md#validation)\<`T`, `F`\>
...
#### Call Signature
 `>` **mapInvalid**\<`E`, `F`\>(`fn`): \<`T`\>(`validation`) => [`Validation`](types.md#validation)\<`T`, `F`\>

Defined in: [validation/mapInvalid/index.ts:64](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/validation/mapInvalid/index.ts#L64)
...
A new validation with transformed errors
 `>` \<`T`\>(`validation`): [`Validation`](types.md#validation)\<`T`, `F`\>

...
#### Call Signature
 `>` **deepMerge**(`objects`, `options?`): [`PlainObject`](types.md#plainobject)

Defined in: [object/deepMerge/index.ts:60](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/object/deepMerge/index.ts#L60)
...
readonly [`PlainObject`](types.md#plainobject)[]

Array of objects to merge

###### options?

[`DeepMergeOptions`](types.md#deepmergeoptions)
...
#### Call Signature
 `>` **deepMerge**(`options?`): (`objects`) => [`PlainObject`](types.md#plainobject)

Defined in: [object/deepMerge/index.ts:61](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/object/deepMerge/index.ts#L61)
...
A new deeply merged object
 `>` (`objects`): [`PlainObject`](types.md#plainobject)

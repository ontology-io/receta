...
### path()
 `>` **path**\<`S`, `A`\>(`pathStr`): [`Lens`](types.md#lens)\<`S`, `A`\>

Defined in: [lens/path/index.ts:55](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/lens/path/index.ts#L55)

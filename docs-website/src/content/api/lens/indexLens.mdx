...
### index()
 `>` **index**\<`A`\>(`idx`): [`Lens`](types.md#lens)\<readonly `A`[], `A` \| `undefined`\>

Defined in: [lens/indexLens/index.ts:49](https://github.com/maxios/receta/blob/cc60b386f67b185c095dab8e7dc7a371fe636c2d/src/lens/indexLens/index.ts#L49)
...
[`Lens`](types.md#lens)\<readonly `A`[], `A` \| `undefined`\>

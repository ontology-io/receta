...
|--------|---------|---------------|
| **[result](_media/result)** | Type-safe error handling | `ok`, `err`, `tryCatch`, `match`, `unwrapOr` |
| **[option](_media/option)** | Nullable value handling | `some`, `none`, `fromNullable`, `unwrapOr` |
| **[async](_media/async)** | Async utilities | `mapAsync`, `retry`, `timeout`, `debounce`, `throttle` |
| **[predicate](_media/predicate)** | Composable predicates | `where`, `gt`, `lt`, `between`, `oneOf`, `and`, `or` |
| **[validation](_media/validation)** | Form/data validation | `validate`, `combine`, `field`, error accumulation |
| **[collection](_media/collection)** | Advanced collections | `nest`, `diff`, `paginate`, `setOps` |
| **[object](_media/object)** | Object manipulation | `flatten`, `unflatten`, `getPath`, `mask`, `deepMerge` |
...
| **[memo](_media/memo)** | Memoization | `memoize`, `memoizeAsync`, TTL/LRU caches |
| **[lens](_media/lens)** | Immutable updates | `prop`, `path`, `over`, `set`, `view` |
| **[compare](_media/compare)** | Comparator builders | `ascending`, `descending`, `natural`, `compose` |
| **[function](_media/function)** | Function combinators | `ifElse`, `when`, `cond`, `compose`, `partial` |
...
- **[Why Receta?](_media/WHY-RECETA.md)** — Real-world problems and solutions
- **[Module Development Guide](_media/module-development-guide.md)** — Contributing new modules
- **Module Guides:**
  - [Result](_media/README.md) — Error handling patterns
  - [Option](_media/README-1.md) — Nullable value handling
  - [Async](_media/README-2.md) — Async utilities and patterns
  - [Predicate](_media/README-3.md) — Composable predicates
  - [Validation](_media/README-4.md) — Form and data validation
  - [Collection](_media/README-5.md) — Advanced collection operations
  - [Object](_media/README-6.md) — Safe object manipulation
  - [String](./docs/string/README.md) — String utilities
  - [Number](./docs/number/README.md) — Number formatting and math
  - [Memo](_media/README-7.md) — Memoization strategies
  - [Lens](_media/README-8.md) — Functional lenses
  - [Compare](_media/README-9.md) — Comparator builders
...
Check the [examples/](_media/examples) directory for real-world usage patterns:
...
[MIT](_media/LICENSE) © 2026 Khaled Maher
